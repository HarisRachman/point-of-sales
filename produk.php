...
<body>
    ...
    <section class="main">
      ...
      <section class="attendance">
        <div class="attendance-list">
          <h1>Data Produk ( <span id="total"></span> )</h1>
  ...
  <!-- <div class="container"> -->
  <div class="modal" id="create-produk">
      <div class="modal-body">
          <h3>Input Produk</h3>
          <div class="form-group">
              <label for=""><b>Masukkan Nama Produk</b></label>
              <input type="text" placeholder="Nama" id="nama" class="form-control">
          </div>
          <div class="form-group">
              <label for=""><b>Pilih Kategori Produk</b></label>
              <select id="kategori-produk" class="form-control">
          ...
          <div class="form-group">
              <label for=""><b>Masukkan Stok Awal</b></label>
              <input type="number" id="stok" class="form-control">
          </div>
          <div class="form-group">
              <label for=""><b>Masukkan Harga Produk</b></label>
  ...
  <!-- edit student -->
  <div class="modal" id="update-produk">
      <div class="modal-body">
          <h3>Update Produk</h3>
          <div class="form-group">
              <label for=""><b>Masukkan Nama Produk</b></label>
              <input type="text" placeholder="Nama" id="edit-nama" class="form-control">
          ...
          <div class="form-group">
              <label for=""><b>Masukkan Gambar Kategori</b></label>
              <input type="file" placeholder="Gambar" id="edit-image" class="form-control">
